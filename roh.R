...
# Przekształca strukturę task$chromosomes na standardowy format filtra:
# chromosom:początekzakresu-konieczakresu
# Chromosom jest obowiązkowy
# Zakres jest opcjonalny
